...
# ----
#   curl -sL https://raw.githubusercontent.com/davidnewhall/motifini/main/scripts/install.sh | sudo bash
#   wget -qO- https://raw.githubusercontent.com/davidnewhall/motifini/main/scripts/install.sh | sudo bash
# ----
#
